...
//OK
	...
	public ResponseEntity<List<Movies>> getByOrder(@RequestParam("order") String order) {
		return new ResponseEntity<>(moviesService.getByOrder(order), HttpStatus.OK);
	}

	@GetMapping(value = "", params = "genderId")
	public List<Movies> getByGenere(@RequestParam("genderId") Integer genderId) {
